...
const NAV_ITEMS = [
  ...
  { href: "/archive", label: "Archive", icon: "M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4" },
  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 h-14 bg-[var(--sidebar-bg)] border-b border-[var(--card-border)] flex items-center px-4 z-50">
        ...
        >
          <svg className="w-6 h-6 text-[var(--sidebar-active)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
            {mobileOpen ? (
